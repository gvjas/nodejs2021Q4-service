...
const getAll = (boardId) => task_memory_repository_1.default.getAllByBoardId(boardId);
...
const pushDB = (task) => task_memory_repository_1.default.pushDB(new task_model_1.default(Object.assign({}, task)));
const update = (task) => task_memory_repository_1.default.update(task);
...
const handlerValidId = (req, res) => handlers_1.default.handlerValidId(req, res, board_service_1.getById, getAll);

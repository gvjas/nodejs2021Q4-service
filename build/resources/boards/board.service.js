...
const pushDB = (board) => board_memory_repository_1.boardsRepo.pushDB(new board_model_1.default(Object.assign({}, board)));
const update = (board) => board_memory_repository_1.boardsRepo.update(board);
...
handlers_1.default.handlerDelete(req, res, getById, del, task_memory_repository_1.default.delAll);
